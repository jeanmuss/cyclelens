...
function buildFreshnessItem(label, metadata, dataset) {
...
function TimestampValue({ value, language, unknown }) {
  if (!value) return <span>{unknown}</span>;
  return (
    <span title={freshnessLabel(value, language)}>
...
function DataFreshnessSummary({ items, language, t }) {
  return (
...
function FreshnessAuditTable({ items, language, t }) {
...
function marketStatusCopy(key, copy) {
  const aliases = {
...
function countdownToIso(value, now, language) {
...
function ChipPendingWatchlist({ assets, categoryById, copy, language }) {
...
function RouteRuntime({ PageComponent, metadata }) {
...
const cryptoMetadata = (t) => ({ title: t.docTitle, description: t.docDescription });
const macroMetadata = (t) => ({ title: t.macroCalendar.docTitle, description: t.macroCalendar.docDescription });
const equityMetadata = (t) => ({ title: t.equity.docTitle, description: t.equity.docDescription });
const marketClockMetadata = (t) => {
  const copy = marketClockCopy(t);
  return { title: copy.docTitle, description: copy.docDescription };
};
const chipChainMetadata = (t) => {
  const copy = chipChainCopy(t);
  return { title: copy.docTitle, description: copy.docDescription };
};
const robotChainMetadata = (t) => {
  const copy = robotChainCopy(t);
  return { title: copy.docTitle, description: copy.docDescription };
};
const macroAdminMetadata = (t) => {
  const copy = adminMacroCopy(t);
  return { title: copy.docTitle, description: copy.docDescription };
};

export function CryptoRoute() {
  return <RouteRuntime PageComponent={CryptoCyclePage} metadata={cryptoMetadata} />;
}

export function MacroRoute() {
  return <RouteRuntime PageComponent={MacroCalendarPage} metadata={macroMetadata} />;
}

export function EquityRoute() {
  return <RouteRuntime PageComponent={EquityMacroPage} metadata={equityMetadata} />;
}

export function MarketClockRoute() {
  return <RouteRuntime PageComponent={MarketClockPage} metadata={marketClockMetadata} />;
}

export function ChipChainRoute() {
  return <RouteRuntime PageComponent={ChipChainPage} metadata={chipChainMetadata} />;
}

export function RobotChainRoute() {
  return <RouteRuntime PageComponent={RobotChainPage} metadata={robotChainMetadata} />;
}

export function MacroAdminRoute() {
  return <RouteRuntime PageComponent={AdminMacroEventsPage} metadata={macroAdminMetadata} />;
}
